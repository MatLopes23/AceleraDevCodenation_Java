...
public class Motorista {
    ...
    public static class MotoristaBuilder {
        ...
        public MotoristaBuilder withIdade(int idade) {
            isNumeroNegativo(idade);
            this.idade = idade;
            return this;
        }

        public MotoristaBuilder withPontos(int pontos) {
            isNumeroNegativo(pontos);
            this.pontos = pontos;
            return this;
        }
        ...
        public Motorista build() {
            isMotoristaValido(nome, idade, pontos, habilitacao);
            return new Motorista(nome, idade, pontos, habilitacao);
        }

        private boolean isNumeroNegativo(int number){
            if(number < 0)
        ...
        private boolean isMotoristaValido(String nome, int idade, int pontos, String habilitacao){
            ...
            if(pontos > 20)
                throw new EstacionamentoException("Motorista não pode estar com habilitação suspensa");
