...
public class Carro {
    ...
    public static class CarroBuilder {
        ...
        private boolean isCarroValido(Motorista motorista, String placa, Cor cor){
            if(placa == null || cor == null)
                throw new NullPointerException();

            if(motorista == null)
                throw new EstacionamentoException("Não não pode ser carro autonomo");

            return true;
        }

        public Carro build() {
            isCarroValido(motorista, placa, cor);
